    ...
    <div class="booking_room">
      <div class="reservation">
        <ul>
          <li class="span1_of_1">
            <h5>关键词：</h5>
            <label style="color: white">${keyWords}</label><br><br>
          </li>
          <li class="span1_of_3">
            <div class="date_btn">
...
<table>
  ...
  <c:forEach items="${restaurants}" var="var">
    <tr>
      <td><img src="/camplus/Images/dish/${var.key.dishImageId}.jpg"></td>
      <td>
        <a href="
          <c:url value="/restaurant/get/${var.value.restaurantId}"></c:url>
        ">${var.value.restaurantName}
        </a>
      </td>
      <td>${var.key.dishName}</td>
      <td>${var.key.dishInfo}</td>
      <td>${var.key.dishScore}</td>
      <td>${var.key.dishPrice}</td>
        <%--<td>${var.value.restaurantPhone}</td>--%>
    </tr>
  </c:forEach>
  </tbody>
</table>
